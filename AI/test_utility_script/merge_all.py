...
for nome_file in os.listdir(cartella_input):
    if nome_file.startswith("ChatGPT") and nome_file.endswith(".txt"):
        ...
        with open(percorso_completo_file, "r") as file_da_leggere:
...
with open(percorso_completo_output1, "w") as file_output1:
    file_output1.write(contenuto_unificato1)


percorso_completo_output2 = os.path.join(cartella_input, file_output2)
with open(percorso_completo_output2, "w") as file_output2:
...
with open(file_poesie_originali, 'r') as file1:
...
with open(file_poesie_originali, 'r') as file1:
    with open(file_label_poesie_originali, 'w') as poesie_originali:
        with open(file_label_poesie_originali, "r+") as poesie_originali:
            for linea in file1:
                if linea[0]=="*":
...
with open(file_poesie_chatgpt, 'r') as file2:
...
with open(file_poesie_chatgpt, 'r') as file2:
    with open(file_label_poesie_chatgpt, 'w') as poesie_chatgpt:
        with open(file_label_poesie_chatgpt, "r+") as poesie_chatgpt:
            for linea in file2:
                if linea[0]=="*":
...
with open(file_poesie_merge, 'w') as file_output:
    file_output.write(poesie_unite)

with open(file_label_merge, 'w') as file_output:
